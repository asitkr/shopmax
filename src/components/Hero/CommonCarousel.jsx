...
const CommonCarousel = () => {
    ...
    // Check if the screen width is less than 767 pixels
    if (screenWidth < 767) {
        return null; // Render nothing or an alternative component
    }
                        ...
                        <div className="item mx-2">
                            <div className="item-entry">
                                <NavLink to="#" className="product-item md-height bg-gray block">
                                    <img src="/assets/model_1.png" alt="model" className="max-w-full lg:h-auto" />
                                </NavLink>
